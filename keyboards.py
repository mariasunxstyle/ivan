...
def get_control_keyboard(step=None):
...
control_keyboard_full.add(KeyboardButton("↩️ Назад на шаг 1 (если был перерыв)"))
...
end_keyboard.add(
    ...
    KeyboardButton("↩️ Назад на шаг 1 (если был перерыв)")
)
