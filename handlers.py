...
# Кнопки после завершения шага (в 4 строки)
control_keyboard_full_vertical = ReplyKeyboardMarkup(resize_keyboard=True)
control_keyboard_full_vertical.add(KeyboardButton("▶️ Продолжить"))
control_keyboard_full_vertical.add(KeyboardButton("📋 Вернуться к шагам"))
control_keyboard_full_vertical.add(KeyboardButton("↩️ Назад на 2 шага"))
control_keyboard_full_vertical.add(KeyboardButton("⛔ Завершить"))

# Кнопки после завершения сеанса (в 2 строки)
end_keyboard = ReplyKeyboardMarkup(resize_keyboard=True, row_width=1)
end_keyboard.add(
